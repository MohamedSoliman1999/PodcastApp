...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class HiltAndroidLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        private final HiltAndroidTestingLibraryAccessors laccForHiltAndroidTestingLibraryAccessors = new HiltAndroidTestingLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>hilt.android.testing</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public HiltAndroidTestingLibraryAccessors getTesting() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForHiltAndroidTestingLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class HiltAndroidTestingLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public HiltAndroidTestingLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getCompiler() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("hilt.android.testing.compiler");
        }
    ...
    public static class JunitLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>junit.android</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class ComposeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>compose.testing</b> with value <b>1.7.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class JunitVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>junit.android</b> with value <b>1.2.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
